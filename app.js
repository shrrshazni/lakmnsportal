      ...
      if (type === 'Annual Leave') {
          ...
          if (amountDayRequest >= 3) {
            if (findFile.length > 0) {
              ...
              res.render('home', {
                ...
                // toast
                show: 'show',
                alert: 'Document attachment is required for sick leave request'
              });
            }
          } else {
            console.log(
        ...
        if (
          ...
          res.render('home', {
            ...
            // toast
            show: 'show',
            alert: 'Insufficient paternity balance for the requested duration'
          });
        }
        ...
        if (
          ...
          res.render('home', {
            ...
            // toast
            show: 'show',
            alert: 'Insufficient maternity balance for the requested duration'
          });
        }
        ...
        if (
          ...
          res.render('home', {
            ...
            // toast
            show: 'show',
            alert: 'Insufficient marriage balance for the requested duration'
          });
        }
