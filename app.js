...
const allowedIPs = [
    '175.140.45.73', '180.74.242.190', '175.142.51.130',
    '118.101.197.198', '60.50.89.1', '180.74.242.233' // 180.75.77.36, 180.74.242.233, 210.186.48.186, 210.186.48.112, 124.82.190.201, 110.159.86.125
];
...
app.post('/api/qrcode/process-data', isAuthenticated, async (req, res) => {
    ...
    const locationMap = {
        '175.140.45.73': 'BMI',
        '180.74.242.190': 'BMII',
        '175.142.51.130': 'JM', // 180.75.77.36
        '118.101.197.198': 'JM', // 110.159.86.125
        '60.50.89.1': 'CM', // 210.186.48.186
        // '210.186.48.112': 'CM',
        // '124.82.190.201': 'CM',
        '180.74.242.233': 'RS'
    };
