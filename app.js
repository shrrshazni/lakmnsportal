                ...
                if (!existing) {
                    ...
                    if (type === 'Annual Leave') {
                        ...
                        if (leaveBalance >= numberOfDays) {
                            ...
                            console.log(
                                'Insufficient leave balance or grade is not above 30 for the requested duration'
                            );
                            ...
                            res.render('home', {
                                ...
                                show: 'show',
                                alert:
                                    'Insufficient annual leave balance or grade is not above 30 for the requested duration'
                            });
                        }
                        ...
                        if (leaveBalance >= numberOfDays) {
                            console.log(numberOfDays);
                            console.log(
                                'Sufficient hajj leave balance for the requested duration'
                            );
                            ...
                            console.log(
                                'Insufficient hajj leave balance for the requested duration'
                            );
